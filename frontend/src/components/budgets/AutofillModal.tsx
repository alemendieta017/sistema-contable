...
export const AutofillModal: React.FC<AutofillModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      <div
        className="relative w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200 flex flex-col max-h-[92vh] sm:max-h-[90vh] z-10"
        style={{
      ...
      >
        ...
        {/* Modal Header */}
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/90">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mt-0.5 flex-wrap">
                ...
                <span>•</span>
                <span className="font-medium text-slate-800 dark:text-slate-200 truncate max-w-[220px] sm:max-w-[280px]">
                  {account.accountName}
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-5 overflow-y-auto flex-1">
              ...
              {DISTRIBUTION_OPTIONS.map((opt) => {
                ...
                return (
                  <div
                    ...
                    className={`relative flex items-start space-x-3.5 p-3.5 rounded-xl border cursor-pointer transition-all duration-150 min-h-[52px] ${
                      isSelected
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl px-3.5 py-3 text-xs font-mono focus:border-indigo-500 outline-none min-h-[44px]"
                  />
                </div>
            ...
            {(driverType === BudgetDriverType.FORWARD_FILL ||
              ...
              <div>
                ...
                <select
                  ...
                  onFocus={handleInputFocus}
                  className="w-full bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-xl px-3.5 py-3 text-xs font-medium focus:border-indigo-500 outline-none min-h-[44px]"
                >
                  {periods.map((p) => {
          ...
          <div className="flex items-center justify-end space-x-3 pt-3 border-t border-slate-200 dark:border-slate-800">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-lg shadow-indigo-600/30 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px]"
            >
              {isLoading ? (
                <>
