...
export default function EditBudgetPage() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 py-2.5 px-5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl text-xs shadow-md shadow-indigo-600/10 hover:shadow-indigo-700/20 transition disabled:opacity-50"
          >
      ...
      {/* Message alerts */}
      {error && (
        <div className="p-4 text-xs text-red-700 bg-red-50/80 dark:bg-red-950/20 dark:text-red-400 rounded-2xl border border-red-200/40 dark:border-red-900/30 flex items-start gap-3">
      ...
      {success && (
        <div className="p-4 text-xs text-green-700 bg-green-50/85 dark:bg-green-950/20 dark:text-green-500 rounded-2xl border border-green-200/40 dark:border-green-900/30 flex items-start gap-3">
      ...
      {budget?.isLocked && (
        <div className="p-4 text-xs text-amber-700 bg-amber-50/80 dark:bg-amber-950/20 dark:text-amber-400 rounded-2xl border border-amber-200/40 dark:border-amber-900/30 flex items-start gap-3">
          <ShieldAlert className="w-4 h-4 mt-0.5 shrink-0" />
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-sm overflow-hidden">
        ...
        {currentTabEligible.length > 0 && !budget?.isLocked && (
          <div className="bg-slate-50/50 dark:bg-slate-800/50 p-4 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center gap-3">
            <span className="text-3xs uppercase tracking-wider font-extrabold text-slate-400 dark:text-slate-500">
              Agregar Partida:
            </span>
            <div className="flex flex-1 w-full sm:w-auto items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-40 disabled:hover:bg-indigo-600 text-white font-bold rounded-xl text-xs shadow-sm hover:shadow transition"
              >
